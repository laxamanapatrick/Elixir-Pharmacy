...
export const RawMatertialInformation = () => {
  return (
    <>
      <Flex justifyContent='center' flexDirection='column' w='full'>
        ...
        <Flex w='full' justifyContent='space-between'>
          ...
          <Text textAlign='center' fontWeight='semibold'>Total Records: {`10`}</Text>
        </Flex>
          ...
          <Flex w='95%' justifyContent='space-between'>
            ...
            <VStack alignItems='start' w='40%' mx={5}>
              ...
              <HStack w='full'>
                ...
                <Input w='full' readOnly bgColor='white' />
              </HStack>
            </VStack>
          </Flex>
        </VStack>
